    ...
    <div class="row">
        <div class="col-12">
          <!--<div class="jumbotron jumbotron-fluid">
            ...
            <h5 style="text-align: center"><a href="https://geidh.uk/briathrachas-lcdte/">BRIATHRACHAS LCDTE+ | LGBTI+ VOCABULARY</a></h5>
            <?php
            ...
            <div class="page-header">
                <h2 style="text-align: center; text-transform: uppercase">Naidheachdan as ùire</h2>
            </div>
            <?php if ( have_posts() ) : ?>
                <?php while ( have_posts() ) : the_post(); ?><div class="row">
                        <div class="col-md-3">
                            <a href="<?php the_permalink(); ?>"><img style="border:1px solid whitesmoke; margin-bottom: 10px;" class="img-fluid" src="<?php the_post_thumbnail_url(); ?>"></a>
                        </div>
                        <div class="col-md-9">
                    ...
                    <!--<p><a href="<?php comments_link(); ?>"><button type="button" class="btn btn-primary" style="background-color: #FB135B !important; border-style: none;"><i class="fa fa-comment"></i> 
                    	<?php
						...
						?></button></a>
						 <a href="https://twitter.com/intent/tweet?text=<?php the_title(); ?>%20<?php echo the_permalink(); ?>&hashtags=LCDTE&#44LGBTI&#44Gàidhlig&#44Gaelic&via=GeidhUK"><button type="button" class="btn btn-primary" style="background-color: #FB135B !important; border-style: none;"><i class="fab fa-twitter"></i> Twitter</button></a>
